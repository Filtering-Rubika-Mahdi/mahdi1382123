...
9XXXXXXXXXXXXXVXXXXXXXXOo. 
.oOXXXXXXXXVXXXXXXXXXXXXXXXP
  9XXXXXXXXXXXXXXX ~ ~ OOO8b d8OOO ~ ~ 
XXXXXXXXXXXXXXXXXP
...
$         https://github.com/mahdi1382123/mahdi1382123
...
if up == "2":
   ...
   print ('code for Channel ≠>' + '%s%s %78ilter.%73 %s' 
% (fg('red'), bg('yellow'), attr('reset')))
...
if up == "4":
   ...
   print ('code for account ≠>' + '%s%s 
http://ufhttk_26357 %s' % (fg('red'), bg('yellow'),
attr('reset'))) 
